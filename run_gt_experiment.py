...
from experiments import gt_experiments
from utils import modules, gt_dataio, losses
...
if (mode == 'all') or (mode == 'train'):
    ...
    experiment_classes_dict = {name: clss for name, clss in inspect.getmembers(gt_experiments, inspect.isclass) if clss.__bases__[0] == gt_experiments.GTExperiment}
...
dataset = gt_dataio.GTReachabilityDataset(
...
experiment_class = getattr(gt_experiments, orig_opt.experiment_class)

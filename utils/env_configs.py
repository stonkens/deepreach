...
class Quad2DAttitude_envs():
    def __init__(self, config_num, problem_type):
        ...
        if self.config_num == 1: 
            ...
            obstacle_space_boundary = boundary_functions.Boundary([0, 1], torch.Tensor([-4.0, 0.0]),
                                                            torch.Tensor([4.0, 2.5]))
            self.sdf_obstacles  = boundary_functions.build_sdf(obstacle_space_boundary, [rectangle2, rectangle3, rectangle4])
...
class Quad6DDelay_envs(): 
    ...
    def __init__(self, config_num, problem_type):
        ...
        if self.config_num == 1:
            ...
            obstacle_space_boundary = boundary_functions.Boundary([0, 4], torch.Tensor([-4.0 * x_scaling_factor, 0.0 * z_scaling_factor]),
                                                            torch.Tensor([4.0 * x_scaling_factor, 2.5 * z_scaling_factor]))
            self.sdf_obstacles  = boundary_functions.build_sdf(obstacle_space_boundary, [rectangle2, rectangle3, rectangle4])
